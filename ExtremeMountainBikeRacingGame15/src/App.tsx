...
import { GameJapanView, ResultsJapanScreen } from '@/components/GameJapanView';
...
import type { JPRaceResult } from '@/gamejp/types';
...
function App() {
  ...
  const [resultsJP, setResultsJP] = useState<JPRaceResult[]>([]);
  ...
  const handleFinishJP = (results: JPRaceResult[]) => {
    setResultsJP(results);
    setScreen('finished');
  };
