...
public class MadMaxStylePostApocalypticRacing {
    public static void main(String[] args) {
        JFrame frame = new JFrame("Wasteland Racer — Mad Max Style Desert Racing");
...
class Car {
    ...
    private void emitDust(double dt, boolean onTrack) {
        ...
        Color c = onTrack ? new Color(200, 180, 140, 120) : new Color(180, 140, 90, 160);
...
class GamePanel extends JPanel implements Runnable, KeyListener {
    ...
    private void drawBackground(Graphics2D g) {
        g.setPaint(new GradientPaint(0, 0, new Color(255, 175, 90), 0, (float) (H * 0.45), new Color(240, 200, 140)));
        ...
        g.setPaint(new RadialGradientPaint(new Point(W - 220, 110), sunR * 3,
                ...
                new Color[]{new Color(255, 250, 200, 220), new Color(255, 200, 100, 90), new Color(255, 200, 100, 0)}));
        ...
        g.setPaint(new GradientPaint(0, (float) (H * 0.4), new Color(214, 178, 120), 0, H, new Color(180, 140, 90)));
    ...
    private void drawMenu(Graphics2D g) {
        ...
        centerText(g, "WASTELAND RACER", H / 2 - 140);
